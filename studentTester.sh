...
timeout $timeoutVal ./student_fin_tester $refFolder/shuffled_freq2.txt out_student_0.txt 10 0 

echo -e "Test 2: 5 multi-char prefixes with runtime\n"
timeout $timeoutVal ./student_fin_tester $refFolder/shuffled_freq2.txt out_student_1.txt 10 1

echo -e "Test 3: 5 multi-chra prefixes with 10 predictComp\n" 
timeout $timeoutVal ./student_fin_tester $refFolder/shuffled_unique_freq_dict.txt out_student_4.txt 10 4 

echo -e "Test 4: 5 multi-chra prefixes with 20 predictComp\n"
timeout $timeoutVal ./student_fin_tester $refFolder/shuffled_unique_freq_dict.txt out_student_4.txt 20 4 

echo -e "Test 5: 5 multi-chra prefixes with 50 predictComp\n"
timeout $timeoutVal ./student_fin_tester $refFolder/shuffled_unique_freq_dict.txt out_student_4.txt 50 4
